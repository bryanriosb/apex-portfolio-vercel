...
const INVOICE_TABLE_HTML = `<table class="tiptap-table" style="width: 100%; table-layout: fixed; border-collapse: collapse; margin-top: 10px; font-size: 14px;"><colgroup></colgroup><tbody><tr style="background-color: rgb(243, 244, 246);"><th style="width: 20%; padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: center; font-size: 14px;"><p>No. Factura</p></th><th style="width: 20%; padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: center;"><p>Monto</p></th><th style="width: 20%; padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: center;"><p>Fecha</p></th><th style="width: 20%; padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: center;"><p>Vencimiento</p></th><th style="width: 20%; padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: center;"><p>Días</p></th></tr><tr><td colspan="5" style="padding: 8px; border: 1px solid rgb(229, 231, 235); font-family: monospace; font-size: 10px; color: rgb(107, 114, 128);"><p>{{#each invoices}}</p></td></tr><tr><td style="padding: 8px; border: 1px solid rgb(229, 231, 235); font-size: 14px;"><p>{{invoice_number}}</p></td><td style="padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: left; font-size: 14px;"><p>{{amount_due}}</p></td><td style="padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: left; font-size: 14px;"><p>{{invoice_date}}</p></td><td style="padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: left; font-size: 14px;"><p>{{due_date}}</p></td><td style="padding: 8px; border: 1px solid rgb(229, 231, 235); text-align: left; font-size: 14px;"><p>{{days_overdue}}</p></td></tr><tr><td colspan="5" style="padding: 8px; border: 1px solid rgb(229, 231, 235); font-family: monospace; font-size: 10px; color: rgb(107, 114, 128);"><p>{{/each}}</p></td></tr></tbody></table>`
