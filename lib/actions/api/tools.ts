...
export async function listTools(
  ...
  try {
    return await query(`/api/agents/${params.agentId}/tools`, queryParams)
  } catch (error) {
...
export async function getTool(
  ...
  return query(`/api/agents/tools/${params.toolId}`)
}

export async function createTool(
  params: CreateToolParams
): Promise<ToolDefinitionResponse> {
  return create(`/api/agents/${params.agentId}/tools`, params.payload)
}

export async function updateTool(
  params: UpdateToolParams
): Promise<ToolDefinitionResponse> {
  return update(`/api/agents/tools/${params.toolId}`, params.payload, false)
}
...
export async function toggleToolActive(
  ...
  return update(
    `/api/agents/tools/${params.toolId}`,
...
export async function authorizeOAuth2(
  ...
  return create(`/api/agents/tools/${params.toolId}/oauth2/authorize`, {
...
export async function refreshOAuth2(
  ...
  return create(
    `/api/agents/tools/${params.toolId}/oauth2/refresh`,
    {},
    {
      params: {
        owner_type: params.ownerType,
...
export async function disconnectOAuth2(
  ...
  return destroy(
    `/api/agents/tools/${params.toolId}/oauth2?owner_type=${params.ownerType}&owner_id=${params.ownerId}`
  )
}
...
export async function discoverOAuth2(
  ...
  return create(`/api/agents/tools/${params.toolId}/oauth2/discover`, {})
}

export async function deleteTool(
  params: DeleteToolParams
): Promise<{ success: boolean }> {
  return destroy(`/api/agents/tools/${params.toolId}`)
}
