...
export const Frame6Cierre: React.FC<Frame6CierreProps> = () => {
  ...
  return (
    <div className="w-full animate-in fade-in duration-500">
      <div className="bg-gray-900 text-white border-4 border-white/20 p-6 sm:p-10 md:p-16 relative overflow-hidden text-center backdrop-blur-2xl mx-4 sm:mx-0 hover:border-[rgba(0,82,255,0.5)] transition-all duration-500">
        {/* Animated background effects - Tailwind animations */}
        <div
          className="absolute inset-0 opacity-30"
          style={{
            background:
              'radial-gradient(circle at 50% 50%, rgba(0,82,255,0.3) 0%, transparent 70%)',
          }}
        />

        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-500/20 rounded-full blur-[100px] animate-pulse [animation-duration:10s]" />

        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-[#0052FF]/10 rounded-full blur-[100px] animate-pulse [animation-duration:12s]" />

        <div className="relative z-10">
          <div className="text-blue-500 font-mono text-xs mb-8 tracking-[0.5em] uppercase font-black flex items-center justify-center gap-3 animate-in slide-in-from-bottom-4 duration-700 fill-mode-forwards">
          ...
          <h2 className="text-3xl sm:text-5xl md:text-7xl lg:text-9xl font-black mb-8 sm:mb-12 tracking-tighter uppercase leading-none animate-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-forwards">
            Active su{' '}
            <span className="text-blue-500 inline-block hover:scale-105 transition-transform duration-300">
              Liquidez
            </span>
          </h2>
