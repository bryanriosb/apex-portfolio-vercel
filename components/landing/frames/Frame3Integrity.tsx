...
export const Frame3Integrity: React.FC<Frame3IntegrityProps> = () => {
  return (
    <div className="w-full relative animate-in fade-in duration-500">
      ...
      <div 
        className="absolute -top-20 right-1/4 w-72 h-72 bg-primary/5 rounded-full blur-3xl pointer-events-none animate-pulse [animation-duration:7s]"
      />
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-20 items-start w-full px-4 sm:px-0">
        <div 
          className="bg-white border-4 border-gray-900 p-4 sm:p-6 lg:p-10 shadow-[8px_8px_0px_#000] lg:shadow-[15px_15px_0px_#000] text-left relative overflow-hidden group shrink-0 hover:shadow-[20px_20px_0px_#1dcd9f] transition-all duration-300"
        >
          <div
        ...
        >
          <div
            className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500 rounded-lg"
          />
