...
export const Frame1Seguridad: React.FC<Frame1SeguridadProps> = () => {
  ...
  return (
    <div className="w-full relative animate-in fade-in duration-500">
      ...
      <div className="absolute -top-32 left-1/4 w-96 h-96 bg-gradient-to-br from-[#0052FF]/5 to-transparent rounded-full blur-3xl pointer-events-none animate-pulse [animation-duration:8s]" />

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-20 items-start w-full px-4 sm:px-0">
        <div className="bg-white border-4 border-gray-900 p-4 sm:p-6 lg:p-10 shadow-[8px_8px_0px_#000] lg:shadow-[15px_15px_0px_#000] text-left relative overflow-hidden group shrink-0 hover:shadow-[20px_20px_0px_#0052FF] transition-all duration-300">
          ...
          <div className="inline-flex items-center gap-2 px-2 py-1 mb-3 sm:mb-6 bg-[#0052FF] text-white font-black text-[10px] sm:text-xs uppercase tracking-widest rounded-none relative overflow-hidden group/btn hover:scale-[1.02] transition-transform duration-200">
