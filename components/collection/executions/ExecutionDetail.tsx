        ...
        <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Creado el {format(new Date(execution.created_at), "d 'de' MMMM, yyyy 'a las' HH:mm", { locale: es })}
                        </p>
                    </div>
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {execution.total_clients > 0 ? ((execution.emails_sent / execution.total_clients) * 100).toFixed(1) : 0}% del total
                        </p>
                    </CardContent>
                </Card>
                <Card>
            ...
            <Card>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                        <span className="font-semibold">Plantilla:</span> {execution.email_template_id || 'N/A'}
                    </div>
                    <div>
                        <span className="font-semibold">Fallback Activado:</span> {execution.fallback_enabled ? 'Sí' : 'No'}
                    </div>
                    <div>
                        <span className="font-semibold">Días Fallback:</span> {execution.fallback_days}
                    </div>
                </CardContent>
            </Card>

            {/* TODO: Add Clients Table & Event Log Components */}
        </div>
    )
}
