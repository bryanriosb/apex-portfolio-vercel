...
const SNIPPET_VARIABLES = [
  {
    ...
    icon: TableIcon,
    snippet: `<table style="width:100%;table-layout:fixed;border-collapse:collapse;margin-top:10px;font-size:14px;"><thead><tr style="background-color:#f3f4f6;"><th style="width:20%;padding:8px;border:1px solid #e5e7eb;text-align:center;font-size:14px;">No. Factura</th><th style="width:20%;padding:8px;border:1px solid #e5e7eb;text-align:center;">Monto</th><th style="width:20%;padding:8px;border:1px solid #e5e7eb;text-align:center;">Fecha</th><th style="width:20%;padding:8px;border:1px solid #e5e7eb;text-align:center;">Vencimiento</th><th style="width:20%;padding:8px;border:1px solid #e5e7eb;text-align:center;">Días</th></tr></thead><tbody><tr><td style="padding:8px;border:1px solid #e5e7eb;font-family:monospace;font-size:10px;color:#6b7280;">{{#each invoices}}</td><td></td><td></td><td></td><td></td></tr><tr><td style="padding:8px;border:1px solid #e5e7eb;font-size:14px;">{{invoice_number}}</td><td style="padding:8px;border:1px solid #e5e7eb;text-align:left;font-size:14px;">{{amount_due}}</td><td style="padding:8px;border:1px solid #e5e7eb;text-align:left;font-size:14px;">{{invoice_date}}</td><td style="padding:8px;border:1px solid #e5e7eb;text-align:left;font-size:14px;">{{due_date}}</td><td style="padding:8px;border:1px solid #e5e7eb;text-align:left;font-size:14px;">{{days_overdue}}</td></tr><tr><td style="padding:8px;border:1px solid #e5e7eb;font-family:monospace;font-size:10px;color:#6b7280;">{{/each}}</td><td></td><td></td><td></td><td></td></tr></tbody></table><p> </p>`,
  },
  {
    key: 'invoices_list',
