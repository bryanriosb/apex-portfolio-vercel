        ...
        <div className="p-5 space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                value={templateType}
                onValueChange={(val) =>
                  onTemplateTypeChange(val as TemplateType)
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <section>
            ...
            <div className="flex justify-between items-center mb-2 px-1">
              <div className="text-[11px] font-normal text-gray-400 dark:text-gray-500 uppercase tracking-wide">
                Tipo
              </div>
              <div className="text-[11px] font-normal text-gray-400 dark:text-gray-500 uppercase tracking-wide">
                Etiqueta
