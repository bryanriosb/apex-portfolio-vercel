...
import { QUICK_TEMPLATES, type QuickTemplate } from '@/lib/data-templates/const/quick-templates'
...
export function QuickTemplatesPanel({ onSelect, onStartBlank }: QuickTemplatesPanelProps) {
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-57px)] bg-gray-50 dark:bg-gray-950 p-6">
            <div className="w-full max-w-5xl">
                ...
                <p className="text-sm text-muted-foreground mb-8">
                    Elige una base y personalízala con el contenido que necesitas. Es rápido y sencillo.
                </p>
                ...
                <div className="flex justify-center mt-6">
                    <Button variant="ghost" onClick={onStartBlank} className="text-muted-foreground hover:text-foreground">
                        Comenzar desde cero
                    </Button>
                </div>
            </div>
    ...
    return (
        <div className="border bg-white dark:bg-gray-900 dark:border-gray-800 flex flex-col p-5 hover:border-gray-400 dark:hover:border-gray-600 transition-colors">
            <div className="flex items-start justify-between mb-3">
                <span className={`text-xs font-semibold px-2 py-0.5 ${BADGE_STYLES[template.badgeColor]}`}>
                    {template.badge}
                </span>
            </div>
